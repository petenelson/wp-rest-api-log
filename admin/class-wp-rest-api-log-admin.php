...
if ( ! class_exists( 'WP_REST_API_Log_Admin' ) ) {
	...
	class WP_REST_API_Log_Admin {
		...
		public function register_scripts() {
			...
			wp_register_script( $this->plugin_name() . '-admin', plugin_dir_url( __FILE__ ) . 'js/wp-rest-api-log-admin.min.js', 'jquery', WP_REST_API_Log_Common::VERSION );
			wp_register_style( $this->plugin_name() . '-admin', plugin_dir_url( __FILE__ ) . 'css/wp-rest-api-log-admin.min.css', '', WP_REST_API_Log_Common::VERSION );
